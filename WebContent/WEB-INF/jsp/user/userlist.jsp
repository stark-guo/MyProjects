	...
	$(function(){
	   ...
	   $("#checkAll").click(function(){
 	   ...
 	   $("#query").click(function(){
 		  	$("#userform").attr("action", "${ctx}/userlistby.action");
 		 	$("#userform").submit();
 	   })
...
<body>
	...
	<form name="userform" method="post" id="userform"
		...
		<!-- 配置pageIndex的隐藏域 -->
		<input type="hidden" name="pageNow" value="${pageModel.pageNow}" id="pageNow">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">登录名：<input type="text" name="loginname"
											value="${sessionScope.user.loginname }" />&nbsp;&nbsp;用户名：<input
											type="text" name="username" value="${sessionScope.user.username }" />
											用户状态：<input type="text" name="status" value="${sessionScope.user.status }"><input
