...
<body>
	...
	<form name="empform" method="post" id="empform" action="${ctx}/employeelist.action">
		<input type="hidden" name="pageNow" value="${pageModel.pageNow}"
			id="pageNow" />
		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.employeelist}" var="employee" varStatus="stat">
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}" name="checkbox"></td>
					 <td>${employee.name }</td>
					  <td>
					        <c:choose>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/updateEmployee?flag=1&id=${employee.id}">
