...
<form action="${ctx}/saveOradd.action" id="deptForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">名称：<input type="text" name="name" value="${dept.getName()}" id="name" size="20"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">描述：<input name="remark" value="${dept.getRemark()}" id="remark" size="20" /></td>
		    		</tr>
